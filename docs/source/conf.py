...
#sys.path.insert(0, os.path.abspath(os.path.dirname(__file__))) # TODO: figure out which one is the right one
...
project = 'vecto'
copyright = '2018, vecto community'
author = 'vecto community'
...
latex_documents = [
    (master_doc, 'mod.tex', 'vecto documentation',
...
man_pages = [
    (master_doc, 'vecto', 'vecto documentation',
     [author], 1)
]
