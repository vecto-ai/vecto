...
def select_method(key):
    options = {}
    if key == 'SpearmanCorrelation':
        method = SpearmanCorrelation(options)
    else:
...
def main():
    ...
    parser.add_argument('--method', help='Spearman Correlation Coefficient', default='SpearmanCorrelation')
